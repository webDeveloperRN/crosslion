...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Panel</a> <a href="../admin/edit-member.php" class="tip-bottom">Miembros</a></div>
</div>
  ...
  echo"<div class='container-fluid'>";
      ...
      echo"<div class='widget-title'> <span class='icon'> <i class='fas fa-info'></i> </span>";
          ...
          echo"<div class='widget-content'>";
              ...
              echo"<a class='btn btn-inverse btn-big'  href='../admin/edit-member.phpñ'>Regresar</a> </div>";
          echo"</div>";
          echo"</div>";
      echo"</div>";
      echo"</div>";
