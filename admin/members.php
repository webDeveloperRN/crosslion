...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Panel</a> <a href="#" class="current">Registro De Miembros</a> </div>
    <h1 class="text-center">Listado De Miembros <i class="fas fa-group"></i></h1>
  </div>
