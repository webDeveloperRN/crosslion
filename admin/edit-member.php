  ...
  <body>
    ...
    <div id="content">
      <div id="content-header">
        <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Panel</a> <a href="#" class="current">Actualización de miembros</a> </div>
        <h1 class="text-center">Actualización de miembros <i class="fas fa-group"></i></h1>
      </div>
      <div class="container-fluid">
        <hr>
        <a href="../admin/member-entry.php" type="submit" class="btn btn-success">Agregar</a>
        <div class="row-fluid">
          <div class="span12">
            ...
            $result=mysqli_query($conn,$qry);
              ...
              echo"<table class='table table-bordered table-hover'>
                ...
                echo"<tbody> 
                    ...
                    <td><div class='text-center'><a href='edit-memberform.php?id=".$row['user_id']."'><i class='fas fa-edit'></i> Editar</a></div></td>
